...
import { startRedeliverySweeper, stopRedeliverySweeper } from './worker/redeliverySweeper.js';
...
const server = createApp().listen(env.PORT, () => {
  ...
  startWorker();
  // Recovers webhooks GitHub gave up on while we were down or asleep.
  startRedeliverySweeper();
});
