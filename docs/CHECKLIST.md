...
- [x] **C2** GitHub sign-in and connecting a repo the user owns: GitHub App user login + installing the app on selected repos
...
## Quality bar
- [x] **Q1** Forged or replayed requests
...
- [x] **Q4** No exposed secrets: `.env` is gitignored, `.env.example` has placeholders, logger redaction, no secrets in the client bundle, tokens encrypted/never sent to the browser
